...
--
-- Host: 192.168.1.165    Database: sellers_taewon
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=10113909 DEFAULT CHARSET=utf8 COMMENT='생산성분석';
...
) ENGINE=InnoDB AUTO_INCREMENT=10000429 DEFAULT CHARSET=utf8 COMMENT='사업전략_파일저장정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000381 DEFAULT CHARSET=utf8 COMMENT='사업전략_마일스톤';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000424 DEFAULT CHARSET=utf8 COMMENT='프로젝트_계약금액상세';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=369 DEFAULT CHARSET=utf8 COMMENT='프로젝트_투자금액상세';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 COMMENT='프로젝트_마일스톤';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000083 DEFAULT CHARSET=utf8 COMMENT='프로젝트계획';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=utf8 COMMENT='전략프로젝트_액션플랜';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='프로젝트계획_파일저장정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000359 DEFAULT CHARSET=utf8 COMMENT='사업전략';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=159 DEFAULT CHARSET=utf8 COMMENT='사업전략_액션플랜';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1140 DEFAULT CHARSET=utf8 COMMENT='캘린더이벤트';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='일정초대';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=518 DEFAULT CHARSET=utf8 COMMENT='캘린더마스터';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='캘린더반복규칙';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=87 DEFAULT CHARSET=utf8 COMMENT='고객사정보_파일저장정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='고객컨택_액션';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='고객이벤트_파일저장정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=333 DEFAULT CHARSET=utf8 COMMENT='고객이벤트';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000068 DEFAULT CHARSET=utf8 COMMENT='고객개인직이력';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='고객관리_고객개인정보_사진저장정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=217 DEFAULT CHARSET=utf8 COMMENT='이슈 해결 계획';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `client_issue_log` (
  ...
  `SOLVE_OWNER` varchar(20) NOT NULL COMMENT '이슈해결책임자',
...
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8 COMMENT='고객이슈로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `client_punching_action_plan` (
  `ACTION_ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '액션아이디',
  `PUNCHING_ID` bigint(20) unsigned NOT NULL COMMENT '이슈아이디',
  `SOLVE_PLAN` varchar(500) DEFAULT NULL COMMENT '이슈해결계획',
  `SOLVE_OWNER` varchar(100) DEFAULT NULL COMMENT '이슈해결책임자',
  `DUE_DATE` date DEFAULT NULL COMMENT '완료예정일자',
  `CLOSE_DATE` date DEFAULT NULL COMMENT '실제완료일자',
  ...
  `SOLVE_FLAG` varchar(1) NOT NULL COMMENT 'NCR,펀칭분류',
  PRIMARY KEY (`ACTION_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=216 DEFAULT CHARSET=utf8 COMMENT='이슈 해결 계획';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `client_punching_log` (
  ...
  KEY `idx_CLIENT_ISSUE_LOG_LOG_01` (`COMPANY_ID`,`CUSTOMER_ID`,`ISSUE_CREATOR`,`ISSUE_CATEGORY`,`ISSUE_SUBJECT`,`ISSUE_DATE`)
) ENGINE=InnoDB AUTO_INCREMENT=125 DEFAULT CHARSET=utf8 COMMENT='고객이슈로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='고객만족조사로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=141 DEFAULT CHARSET=utf8 COMMENT='고객만족 이슈 해결 계획';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='고객만족상세로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='권한정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=163 DEFAULT CHARSET=utf8 COMMENT='메일공유로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000055 DEFAULT CHARSET=utf8 COMMENT='메뉴';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000387 DEFAULT CHARSET=utf8 COMMENT='성과관리_매출목표';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000500 DEFAULT CHARSET=utf8 COMMENT='알림정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=452 DEFAULT CHARSET=utf8 COMMENT='영업기회_체크리스트';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10003106 DEFAULT CHARSET=utf8 COMMENT='영업기회_매출계획금액';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=513 DEFAULT CHARSET=utf8 COMMENT='영업기회_체크리스트';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=377 DEFAULT CHARSET=utf8 COMMENT='영업기회_owner_체크리스트';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='영업기회_파일저장정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='잠재영업기회 액션플랜';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8 COMMENT='잠재영업기회로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=utf8 COMMENT='영업기회로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=131 DEFAULT CHARSET=utf8 COMMENT='영업기회 히스토리';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=503 DEFAULT CHARSET=utf8 COMMENT='영업기회_마일스톤';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=335 DEFAULT CHARSET=utf8 COMMENT='영업기회_윈_플랜';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000023 DEFAULT CHARSET=utf8 COMMENT='부서정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000203 DEFAULT CHARSET=utf8 COMMENT='우리직원정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000055 DEFAULT CHARSET=utf8 COMMENT='팀정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000339 DEFAULT CHARSET=utf8 COMMENT='파트너얼라인먼트_고객사별맵';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000330 DEFAULT CHARSET=utf8 COMMENT='파트너얼라인먼트_산업별갭';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000076 DEFAULT CHARSET=utf8 COMMENT='파트너얼라인먼트_고객사별리스트';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10001413 DEFAULT CHARSET=utf8 COMMENT='파트너얼라인먼트_산업별맵';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10001407 DEFAULT CHARSET=utf8 COMMENT='파트너얼라인먼트_산업별갭';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000240 DEFAULT CHARSET=utf8 COMMENT='파트너얼라인먼트_산업별리스트';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='파트너협업_액션플랜';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000077 DEFAULT CHARSET=utf8 COMMENT='파트너_케이던스로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1000855 DEFAULT CHARSET=utf8 COMMENT='협력회사정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='파트너사정보_파일저장정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='파트너_리크루트_로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000012 DEFAULT CHARSET=utf8 COMMENT='CRB 로그 파일정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='파트너_리크루트_마스터';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='파트너_리크루트_로그';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000005 DEFAULT CHARSET=utf8 COMMENT='교육계획_파일저장정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='협력회사직원정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='파트너_리크루트_산업';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4631 DEFAULT CHARSET=utf8 COMMENT='파트너_세일즈링크';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000017 DEFAULT CHARSET=utf8 COMMENT='파트너협업_파일저장정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='협력회사스킬맵';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000042 DEFAULT CHARSET=utf8 COMMENT='프로젝트관리';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000499 DEFAULT CHARSET=utf8 COMMENT='프로젝트_계약금액상세';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='프로젝트계획_파일저장정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8 COMMENT='프로젝트관리_마일스톤';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8 COMMENT='프로젝트관리_마일스톤';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='프로젝트계획_파일저장정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000013 DEFAULT CHARSET=utf8 COMMENT='제안관리';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000026 DEFAULT CHARSET=utf8 COMMENT='경쟁사';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10020870 DEFAULT CHARSET=utf8 COMMENT='영업영역얼라인먼트맵';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10000041 DEFAULT CHARSET=utf8 COMMENT='벤더솔루션영역';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping routines for database 'sellers_taewon'
--
...
-- Dump completed on 2017-02-10 16:10:27
