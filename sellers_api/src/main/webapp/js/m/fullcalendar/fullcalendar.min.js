        ...
        function r(t) {
            return function(t) {
                ...
                return i.__extends(e, t), e.prototype.renderHeadIntroHtml = function() {
                    var t = this.view;
                    return this.colWeekNumbersVisible ? '<th style="display:none;" class="fc-week-number ' + t.calendar.theme.getClass("widgetHeader") + '" ' + t.weekNumberStyleAttr() + "><span>" + s.htmlEscape(this.opt("weekNumberTitle")) + "</span></th>" : ""
                }, e.prototype.renderNumberIntroHtml = function(t) {
                    var e = this.view,
                        n = this.getCellDate(t, 0);
                    return this.colWeekNumbersVisible ? '<td style="display:none;" class="fc-week-number" ' + e.weekNumberStyleAttr() + ">" + e.buildGotoAnchorHtml({
                        date: n,
                        type: "week",
                    ...
                    var t = this.view;
                    return this.colWeekNumbersVisible ? '<td style="display:none;" class="fc-week-number ' + t.calendar.theme.getClass("widgetContent") + '" ' + t.weekNumberStyleAttr() + "></td>" : ""
                }, e.prototype.renderIntroHtml = function() {
                    var t = this.view;
                    return this.colWeekNumbersVisible ? '<td style="display:none;" class="fc-week-number" ' + t.weekNumberStyleAttr() + "></td>" : ""
                }, e.prototype.getIsNumbersVisible = function() {
            ...
            o = function() {
                ...
                return t.prototype.setToolbarOptions = function(t) {
                    ...
                    var t = this.toolbarOptions.layout,
                        e = this.el;//캘린더 헤더 숨기기
                    t ? (e ? e.empty() : e = this.el = r("<div style='display:none;' class='fc-toolbar " + this.toolbarOptions.extraClasses + "'/>"), e.append(this.renderSection("left")).append(this.renderSection("right")).append(this.renderSection("center")).append('<div class="fc-clear"/>')) : this.removeElement()
                    ...
                    return u && r.each(u.split(" "), function(t, s) {
                        ...
                        r.each(s.split(","), function(t, s) {
                        	var l, u, g, v, y, m, b, w;
                            "title" == s ? (h = h.add(r("<h2 id='ymd' style='display:none;'>&nbsp;</h2>")), f = !1) : ((l = d[s]) ? (g = function(t) {
                                ...
                                n[s]()																																													//prev 버튼 숨김
                            }, (y = c[s]) || (v = o.getIconClass(s)) || (y = p[s])), g && (b = ["fc-" + s + "-button", o.getClass("button"), o.getClass("stateDefault")], y ? m = i.htmlEscape(y) : v && (m = "<span style='display:none;' class='" + v + "'></span>"), w = r('<button style="display:none;" type="button" class="' + b.join(" ") + '">' + m + "</button>").click(function(t) {
            ...
            u = function(t) {
                ...
                return o.__extends(e, t), e.prototype.renderBgRanges = function(e) {
                    ...
                    var n, r, i = this.view,
                        ...
                        h = "";
                    return c.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getTimeText(t.footprint)) && (h = '<span class="fc-time" style="display:none;">' + a.htmlEscape(n) + "</span>"), r = '<span class="fc-title">' + (a.htmlEscape(o.title || "") || "&nbsp;") + "</span>", '<a class="' + c.join(" ") + '"' + (o.url ? ' href="' + a.htmlEscape(o.url) + '"' : "") + (p ? ' style="' + p + '"' : "") + '><div class="fc-content">' + (this.dayGrid.isRTL ? r + " " + h : h + " " + r) + "</div>" + (u ? '<div class="fc-resizer fc-start-resizer" />' : "") + (d ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
                }, e
            }(l.default);
        e.default = u
    }, function(t, e, n) {
