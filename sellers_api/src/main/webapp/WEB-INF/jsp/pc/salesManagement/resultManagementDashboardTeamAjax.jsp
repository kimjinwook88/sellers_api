...
<c:choose>
	<c:when test="${fn:length(selectResultDashBoardTeam) > 0}">
		<c:forEach items="${selectResultDashBoardTeam}" var="items">
			...
			<th><img src="../images/pc/icon_folder_plus.png" class="btn_bottom_dep" onclick="dashboard.memberGet('${items.MEMBER_DIVISION}','${items.MEMBER_TEAM}',this)" /> <a href="javascript:void(0);">${items.TEAM_NAME}</a></th>
