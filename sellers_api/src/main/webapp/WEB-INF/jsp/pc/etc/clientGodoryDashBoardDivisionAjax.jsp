	...
	<c:when test="${fn:length(selectClientIssueDashBoardDivision) > 0}">
		<c:forEach items="${selectClientIssueDashBoardDivision}" var="division" varStatus="status">
			<tr class="tr_list">
				...
				<td class="ag_c">
					<a href="javascript:void(0);" onClick="if(dashboard.countCheck(this))dashboard.goList('${division.DIVISION_NO}',null,null,'고쳐주세요');">
						<fmt:formatNumber value="${division.CATEGORY_1}" groupingUsed="true"/>
					</a>
				</td>
				<td class="ag_c">
					<a href="javascript:void(0);" onClick="if(dashboard.countCheck(this))dashboard.goList('${division.DIVISION_NO}',null,null,'도와주세요');">
						<fmt:formatNumber value="${division.CATEGORY_2}" groupingUsed="true"/>
					</a>
				</td>
				<td class="ag_c">
					<a href="javascript:void(0);" onClick="if(dashboard.countCheck(this))dashboard.goList('${division.DIVISION_NO}',null,null,'이건어때요');">
...
<c:if test="${fn:length(selectClientIssueDashBoardDivision) > 0}">
	<tr class="total">
		...
		<td class="ag_c">
			<a href="javascript:void(0);" onClick="if(dashboard.countCheck(this))dashboard.goList(null,null,null,'고쳐주세요');">
				<fmt:formatNumber value="${sumIssueCategory1}" groupingUsed="true"/>
			</a>
		</td>
		<td class="ag_c">
			<a href="javascript:void(0);" onClick="if(dashboard.countCheck(this))dashboard.goList(null,null,null,'도와주세요');">
				<fmt:formatNumber value="${sumIssueCategory2}" groupingUsed="true"/>
			</a>
		</td>
		<td class="ag_c">
			<a href="javascript:void(0);" onClick="if(dashboard.countCheck(this))dashboard.goList(null,null,null,'이런건어때요');">
