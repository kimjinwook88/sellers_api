...
var dashboard = {
		...
		divisionGet : function(callback){
			var params = $.param({
				...
				datatype : 'html',
				jsp : '/clientSatisfaction/clientIssueIndividualDashBoardDivisionAjax'
			});
			$.ajax({
				url : "/clientSatisfaction/selectClientIssueDashBoardDivision.do",
				datatype : 'html',
				method: 'POST',
				data : params,
		...
		teamGet : function(division, obj, callback){
			...
			var params = $.param({
				...
				searchDate : quarterDate,
				datatype : 'html',
				jsp : '/clientSatisfaction/clientIssueIndividualDashBoardTeamAjax'
			});
		...
		employeeGet : function(division, team, obj){
			...
			var params = $.param({
				...
				searchDate : quarterDate,
				datatype : 'html',
				jsp : '/clientSatisfaction/clientIssueIndividualDashBoardMemberAjax'
			});
