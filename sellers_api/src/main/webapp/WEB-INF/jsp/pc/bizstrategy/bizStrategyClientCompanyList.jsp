                    ...
                    <div class="clear">
                        <div class="pos-rel">
				                    ...
				                    <div class="search-detail" style="display:none;">
				                    	<form id="formSearchDetail">
					                        <div class="col-sm-12 m-b">
					                            ...
					                            <div class="input-group" style="width:100%;" ><input type="text" placeholder="본부를 입력해주세요" class="input form-control" id="textSearchDivision" name="textSearchDivision" onkeydown="if(event.keyCode == 13){bizList.reset();bizList.get(1);}"></div>
					                        </div>
					                        
					                        <div class="col-sm-12 m-b">
									    	<label class="control-label" for="date_modified">책임리더</label>
					                  		<div class="input-group" style="width:100%;" ><input type="text" placeholder="책임리더를 입력해주세요" class="input form-control" id="textSearchOwner" name="textSearchOwner" onkeydown="if(event.keyCode == 13){bizList.reset();bizList.get(1);}"></div>
					                        </div>
                            ...
                            <div class="func-top-right fl_r pd-b20">
                            	<div class="fl_l template-doc">
                                    ...
                                    <!-- 
                                      ...
                                      <li><a href="javascript:void(0);" onclick="downFile.selectSampleFile(this, 'clientBizFile');">사업전략(Industry_Play).xlsx</a></li>
					                   <li><a href="javascript:void(0);" onclick="downFile.selectSampleFile(this, 'clientBizFile');">사업전략(Industry_Play_Summary).xlsx</a></li>
						    ...
						    <tr>
						        ...
						        <th name="cols_ISSUE_STATUS"><a href="#" class="sortLink" data-sort="TB.ISSUE_ACTION_STATUS_TEXT" data-method="">이슈<br />상태 <img src="<%=request.getContextPath()%>/images/pc/icon_sort.png" /></a></th>
...
<jsp:include page="/WEB-INF/jsp/pc/bizstrategy/bizStrategyClientCompanyModal.jsp"/>
...
var bizList = {
		...
		get : function(pn, ep){
				var listParams = $.param({
					datatype : 'html',
					jsp : '/bizstrategy/bizStrategyClientCompanyListAjax'
				});
