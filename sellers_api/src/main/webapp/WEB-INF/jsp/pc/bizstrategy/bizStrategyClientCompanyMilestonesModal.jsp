...
var milestone = {
						...
						formatter: function (rowId, cellval , colpos, rwdat, _act){
							if(rwdat == "edit"){
								...
								case "R":
									...
									break;
								case "N":
									$milestone.setCell(cellval.rowId,"STATUS","",{"background-color": ""});
									break;
								default:
									return "";
									break;
			...
			changeStatus : function(){
				...
				if((dueDate >= nowDate) && closeDate == ""){
					...
					$milestone.jqGrid('setCell', milestone.lastEdit, 'STATUS', 'N');
					$milestone.jqGrid('setCell', milestone.lastEdit, 'HIDDEN_STATUS', null);
