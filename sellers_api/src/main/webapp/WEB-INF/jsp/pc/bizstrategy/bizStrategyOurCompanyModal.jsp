	                                    ...
	                                    <div class="col-sm-4">
	                                        <div class="select-com"><!-- <label>항목선택</label> --> 
										    	 <select class="form-control" name="selectModalCategory" id="selectModalCategory">
		                                            ...
		                                            <option value="회사전략">회사전략</option>
		                                            <!-- <option value="부문전략">부문전략</option> -->
		                                            <option value="본부전략">본부전략</option>
		                                            <option value="팀전략">팀전략</option>
	                                        	</select>
	                                        </div>
	                                    </div>
	                               </div>
	                                    ...
	                                    <div class="form-group"><label class="col-sm-2 control-label"><i class="fa fa-check" style="color: green;"></i> 주요내용</label>
                                          ...
                                          <div class="tab-area">
                                                ...
                                                <div class="sub_cont scont1 modaltabmenu">
                                                	<%-- <jsp:include page="/WEB-INF/jsp/pc/bizstrategy/bizStrategyOurCompanyMilestonesModal.jsp" flush="false">
                                                ...
                                                <div class="sub_cont scont2 modaltabmenu off">
                                                	<%-- <jsp:include page="/WEB-INF/jsp/pc/bizstrategy/bizStrategyOurCompanyIssueModal.jsp"/> --%>
...
var modal = {
		...
		reset : function() { //신규등록 시 팝업창 초기화
			...
			$("h4.modal-title").html("회사/부문별전략 신규 등록");
			$("#selectModalCategory").val(searchCategory).attr("selected", "selected");
			...
			$('#formModalData').ajaxForm({ 
	            ...
	            success: function(data){
	                ...
	                if(data.cnt > 0){
						...
						if(cat == "회사전략"){
							bizList.categoryTab(1,$('ul.nav.nav-tabs li a:contains("'+cat+'")')["0"]);
						}else if(cat == "본부전략"){
							bizList.categoryTab(3,$('ul.nav.nav-tabs li a:contains("'+cat+'")')["0"]);
						}else if(cat == "팀전략"){
							bizList.categoryTab(4,$('ul.nav.nav-tabs li a:contains("'+cat+'")')["0"]);
						}
