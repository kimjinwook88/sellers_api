...
<c:choose>
	<c:when test="${fn:length(selectOpportunityDashBoardMember) > 0}">
		<c:forEach items="${selectOpportunityDashBoardMember}" var="items">
				...
				<th><a href="javascript:void(0);" onClick="dashboard.goList('${items.MEMBER_DIVISION}','${items.MEMBER_TEAM}','${items.MEMBER_ID_NUM}');"> ${items.HAN_NAME}</a></th>
				...
				<td>
					<a href="javascript:void(0);" onClick="dashboard.goList('${items.MEMBER_DIVISION}','${items.MEMBER_TEAM}','${items.MEMBER_ID_NUM}','In');">
				...
				<td>
					<a href="javascript:void(0);" onClick="dashboard.goList('${items.MEMBER_DIVISION}','${items.MEMBER_TEAM}','${items.MEMBER_ID_NUM}','Out');">
