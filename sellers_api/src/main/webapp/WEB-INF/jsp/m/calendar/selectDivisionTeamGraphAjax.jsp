	...
	//alert(len);	
		function drawChart() {
			...
			<c:forEach items="${rows}" var="divisionStatus" varStatus="status">
				names${status.index} = '${divisionStatus.HAN_NAME}';
			...
			// 회사 전에이름 고정
			var companyName = '${rows[0].TEAM_NAME}';
			...
			<c:choose>
				<c:when test="${gridFaceTimeGraphData.VIEWTYPE == 'y'}">
					var now_quarter = '${gridFaceTimeGraphData.NOW_QUARTER0}';
					
					var now_month1 = '${gridFaceTimeGraphData.NOW_QUARTER1}';
					var now_month2 = '${gridFaceTimeGraphData.NOW_QUARTER2}';
					var now_month3 = '${gridFaceTimeGraphData.NOW_QUARTER3}';
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${gridFaceTimeGraphData.VIEWTYPE == 'y'}">
					var now_quarter_A = ${gridFaceTimeGraphData.LEQ0_1};
					var now_quarter_B = ${gridFaceTimeGraphData.LEQ0_2};
					var now_quarter_C = ${gridFaceTimeGraphData.LEQ0_3};
					var now_quarter_D = ${gridFaceTimeGraphData.LEQ0_4};
					var now_quarter_E = ${gridFaceTimeGraphData.LEQ0_5};
					var now_quarter_F = ${gridFaceTimeGraphData.LEQ0_6};
					var now_quarter_G = ${gridFaceTimeGraphData.LEQ0_7};
					var now_quarter_H = ${gridFaceTimeGraphData.LEQ0_8};
					
					var quarter_A1 = ${gridFaceTimeGraphData.LEQ1_1};
					var quarter_B1 = ${gridFaceTimeGraphData.LEQ1_2};
					var quarter_C1 = ${gridFaceTimeGraphData.LEQ1_3};
					var quarter_D1 = ${gridFaceTimeGraphData.LEQ1_4};
					var quarter_E1 = ${gridFaceTimeGraphData.LEQ1_5};
					var quarter_F1 = ${gridFaceTimeGraphData.LEQ1_6};
					var quarter_G1 = ${gridFaceTimeGraphData.LEQ1_7};
					var quarter_H1 = ${gridFaceTimeGraphData.LEQ1_8};
					
					var quarter_A2 = ${gridFaceTimeGraphData.LEQ2_1};
					var quarter_B2 = ${gridFaceTimeGraphData.LEQ2_2};
					var quarter_C2 = ${gridFaceTimeGraphData.LEQ2_3};
					var quarter_D2 = ${gridFaceTimeGraphData.LEQ2_4};
					var quarter_E2 = ${gridFaceTimeGraphData.LEQ2_5};
					var quarter_F2 = ${gridFaceTimeGraphData.LEQ2_6};
					var quarter_G2 = ${gridFaceTimeGraphData.LEQ2_7};
					var quarter_H2 = ${gridFaceTimeGraphData.LEQ2_8};
		
					var quarter_A3 = ${gridFaceTimeGraphData.LEQ3_1};
					var quarter_B3 = ${gridFaceTimeGraphData.LEQ3_2};
					var quarter_C3 = ${gridFaceTimeGraphData.LEQ3_3};
					var quarter_D3 = ${gridFaceTimeGraphData.LEQ3_4};
					var quarter_E3 = ${gridFaceTimeGraphData.LEQ3_5};
					var quarter_F3 = ${gridFaceTimeGraphData.LEQ3_6};
					var quarter_G3 = ${gridFaceTimeGraphData.LEQ3_7};
					var quarter_H3 = ${gridFaceTimeGraphData.LEQ3_8};
				</c:when>
				<c:otherwise>
