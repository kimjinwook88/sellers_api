...
public class CommonUtils {
	 ...
	 * @author 	: 욱이
	 * @Date		: 2016. 09. 29.
	 * @explain	: pattern 형식 리턴 
	 * ex) yyyyMMdd, yyyy-MM-dd, yyyy-MM-dd HH:mm:ss.SSS
	 */
	 ...
	 * @explain	: jsonList
	 */
	public static ArrayList<HashMap<String, Object>> jsonList(String data) throws JsonParseException, JsonMappingException, IOException {
	 ...
	 * @author  : 욱이
	 * @date : 2017. 3. 2.
	 * @explain : 리스트 페이징 계산 처리
	 * paging 정보와 list count를 받아서 계산
	 */
